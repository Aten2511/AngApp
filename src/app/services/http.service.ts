...
station:Station;
  ...
  getStationById(id:string){
    return this._http.get(this.url+'/Stations/'+id);
...
//not used  
  ...
  GetDataByStation(stationid:string,year:number,frekv:string){
    return this._http.get(this.url+'/Measurements/station/'+stationid+'/'+year+'/'+frekv);
  }
